          ...
          {submitted ? (
            <div className="p-8 text-center">
              ...
              <p className="text-sm mb-1" style={{ color: 'var(--lc-muted)' }}>
                If <span style={{ color: 'var(--lc-text)' }}>{email}</span> is registered, you'll receive a reset link shortly.
              </p>
              <p className="text-xs mt-4 mb-6" style={{ color: 'var(--lc-muted)' }}>
            ...
            <>
              ...
              <div className="px-8 py-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <p className="text-center text-xs" style={{ color: 'var(--lc-muted)' }}>
                    <Link to="/login" style={{ color: 'var(--lc-orange)' }}>Back to Login</Link>
                  </p>
                </form>
              </div>
            </>
